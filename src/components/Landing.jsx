      ...
      >
        <Grid lg={6}>
          <div style={{ marginTop: 100, padding: 30 }}>
            ...
            <Typography variant={"h4"} style={{color:"#5dade2"}}>Turn your expertise into income,</Typography>
            <Typography variant={"h4"} style={{color:"#2e86c1"}}>while changing lives.</Typography>
